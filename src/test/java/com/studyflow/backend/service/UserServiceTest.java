...
class UserServiceTest {
    ...
    void shouldCreateUserSuccessfully() {
        UserRequestDTO dto = UserRequestDTO.builder()
                .name("Joao Silva").email("joao@email.com").password("senha123").build();
        User savedUser = User.builder()
                .id(1L).name("Joao Silva").email("joao@email.com").password("encodedPassword").build();
    ...
    void shouldReturnAllUsers() {
        User user1 = User.builder().id(1L).name("User 1").email("user1@email.com").build();
        User user2 = User.builder().id(2L).name("User 2").email("user2@email.com").build();
